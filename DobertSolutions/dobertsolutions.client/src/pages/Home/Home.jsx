            ...
            <div className="home-container">
                <div className="left-panel">
                    ...
                    <p> It's a pleasure to meet you, I'm Trenton Dobert, an experienced ASP.NET Full Stack Web Developer
                        with 8+ years of experience in developing scalable, efficient,
                ...
                <div className="right-panel">
                    <div className="profile-wrapper">
                        ...
                        <div className="contact-info">
                            ...
                            <p><strong>GitHub:</strong> <FontAwesomeIcon icon={faGithub} />{' '} <a className="contact-item" href="https://github.com/trentondobert" target="_blank" rel="noopener noreferrer">github.com/trentondobert</a></p>
                            <p><strong>LinkedIn:</strong> <FontAwesomeIcon icon={faLinkedin} />{' '} <a className="contact-item" href="https://linkedin.com/in/trenton-dobert-5a53a3b8" target="_blank" rel="noopener noreferrer">linkedin.com/in/trenton-dobert-5a53a3b8</a></p>
                        </div>
                    </div>
                </div>
